...
#define async_exception_state(t) async_exception_state[(t)-1]
	...
	//uint64_t steal_time_prev;
	//uint64_t steal_time_sum;
};
...
void schedule_customized_dump(struct cpupool *c);	/*added*/
extern void dump_runq(unsigned char key);
extern void dump_customized(unsigned char key);     /*added*/
